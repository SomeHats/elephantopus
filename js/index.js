...
(function(){
  var $, $$, neededInteractions, stage, view, renderer, seaContainer, bg, soundBubbleEvil, soundBubbleFriendly, soundDeath, playSound, elephantopus, elscale, healthIndicator, tentacles, trunk, pointer, blurFilter, backgroundShader, debugging, bubbles, clearingVision, visionIndicator, visionIndicatorBar, mouse, keys, npcs, acc, damp, maxSpeed, world, velocity, animate;
  $ = function(s){
  ...
  neededInteractions = random(15, 25);
  ...
  window.addEventListener('keypress', function(e){
    if (e.which === 98 && debugging === false) {
      seaContainer.filters = null;
      seaContainer.position = {
        x: 1080 * 0.45,
        y: 720 * 0.45
      };
      seaContainer.scale = {
    ...
    } else if (e.which === 98 && debugging === true) {
      seaContainer.filters = [blurFilter];
      seaContainer.position = {
        x: 0,
        y: 0
