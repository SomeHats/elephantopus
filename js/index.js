...
(function(){
  var $, $$, stage, view, renderer, bg, seaContainer, elephantopus, healthIndicator, elscale, tentacles, trunk, blurFilter, backgroundShader, bubbles, clearingVision, visionIndicator, visionIndicatorBar, mouse, keys, npcs, acc, damp, maxSpeed, world, velocity, animate;
  $ = function(s){
