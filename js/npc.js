...
(function(){
  var neutral, aggressive, shy, NPC, randomNpc, rhinopusSpec, NPCController;
  ...
  window.NPC = NPC = (function(superclass){
    ...
    function NPC(arg$, x, y){
      var sprite, ai, pivot, maxSpeed, ref$, extra, collide, scale, init, update, texture;
      sprite = arg$.sprite, ai = arg$.ai, pivot = arg$.pivot, maxSpeed = (ref$ = arg$.maxSpeed) != null ? ref$ : 3, extra = (ref$ = arg$.extra) != null
        ...
        : function(){
          return null;
        }, scale = (ref$ = arg$.scale) != null ? ref$ : 0.3, init = (ref$ = arg$.init) != null
        ? ref$
        : function(){
          return null;
        }, update = (ref$ = arg$.update) != null
        ? ref$
        : function(){
          return null;
        };
  ...
  rhinopusSpec = {
    ...
    init: function(rh){
      ...
      rh.addChild(tentacles);
      return rh.tentacles = tentacles;
    },
    update: function(rh, t){
      return rh.tentacles.update(t);
    }
  };
  window.NPCController = NPCController = (function(superclass){
    ...
    function NPCController(n){
      ...
      this.spawnRhinopus = bind$(this, 'spawnRhinopus', prototype);
    ...
    prototype.spawnRhinopus = function(){
      var this$ = this;
      if (!this.spawnedRhinopus) {
        this.spawnedRhinopus = true;
        window.rhinopus = this.addNpc(this.pad, rhinopusSpec);
        return setTimeout(function(){
          var ref$;
          return (ref$ = this$.npcs)[ref$.length] = window.rhinopus;
        }, 1);
      }
    };
    prototype.addNpc = function(pad, npcSpec){
      var px, py, s, x, y, npc, ref$;
      pad == null && (pad = this.pad);
      npcSpec == null && (npcSpec = randomNpc());
      px = random(-1080, 1080);
      py = random(-1080, 1080);
      s = Math.random();
      switch (false) {
    ...
    prototype.update = function(t, v){
      ...
      for (i$ = 0, len$ = (ref$ = this.npcs).length; i$ < len$; ++i$) {
        ...
        if (npc.position.x < this.minX || npc.position.x > this.maxX || npc.position.y < this.minY || npc.position.y > this.maxY) {
          ...
          if (npc.extra.isRhinopus) {
            rh = this.addNpc(this.pad, rhinopusSpec);
            window.rhinopus = rh;
            newNpcs[newNpcs.length] = rh;
          } else {
